...
- **طرح قبل از اجرا**: برای هر درخواست اول با agent `plan` طرح پیشنهادی می‌دهد و بعد از تأیید تو (دکمهٔ «شروع کن») همان درخواست را اجرا می‌کند
...
> ربات **تک‌کاره** است: در هر لحظه فقط یک کار اجرا می‌شود. اگر هنگام اجرا پیام جدیدی بفرستی، ربات می‌پرسد «متوقف کنم یا ادامه بدهم؟» و هر درخواست اول طرح می‌شود و بعد از تأیید تو اجرا می‌شود.
